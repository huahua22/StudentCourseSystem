		...
		$.ajax({
			...
			success : function(data) {
				...
				$.each(data, function(i, obj) {
					str += "<tr>" + "<td width='15%'>" + obj.course_no + "</td>"
							+ "<td width='20%'>" + obj.course_name + "</td>"
							+ "<td width='15%'>" + obj.up_limit + "</td>"
							+ "<td width='15%'>" + obj.course_status + "</td>"
							+ "<td width='15%'>" + obj.teacher_no+ "</td>"
							+ "<td width='20%'>" + obj.teacher_name + "</td>"
							+ "</tr>";
				});
				$("#table").append(str);
