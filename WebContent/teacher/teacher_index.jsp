...
<frameset frameborder="0" rows="80,*">
	<frame src="<%=request.getContextPath()%>/teacher/header.jsp" noresize="noresize" scrolling="no" />
	<frameset frameborder="0" cols="20%,80%">
		<frame src="<%=request.getContextPath()%>/teacher/teacher_left.jsp" noresize="noresize" scrolling="no" />
